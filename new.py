...
# graph5.add_node(0,x =0,y=10,z=30,color='red')
# graph5.add_node(1,x =0,y=20,z=30)
#graph5.add_node(2,x =0,y=30,z=30)
...
fig = gv.d3(graph5, graph_height=500, edge_curvature=0.3, show_node_label=False)
