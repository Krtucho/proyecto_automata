...
doctors=[doctor1, doctor2, doctor3, doctor4, doctor5, doctor6, doctor7, doctor8, doctor9, doctor10]
...
#-------------------------------------------------------Metodo principal-----------------------------------------------------------------------------
def ac_3(csp, doctors_queue, aparatos_queue, pacient_dicc, list_marks_doctors, list_marks_aparatos, doctors_graph, aparatos_graph): # returns the CSP, posibly with reduced domains
...
def backtracking_search(doctors_queue, aparatos_queue, pacient_dicc, doctors_graph, aparatos_graph): # Returns solution/failure
    csp=copy.deepcopy(pacient_dicc)
    return ac_3(csp, doctors_queue, aparatos_queue, pacient_dicc, [], [], doctors_graph, aparatos_graph)

#----------------------------------------------------------------------------------------------------------------------------------------------

def hospital_simulation(pacientes_list, aparatos, cirugias):
    ...
    doctors_graph, aparatos_graph = fill_graph(pacientes_list)

    ac_3=backtracking_search(edge_sort(doctors_graph, "doctors",pacientes_rel_doct_apar_dicc.copy()), edge_sort(aparatos_graph, "aparatos",pacientes_rel_doct_apar_dicc.copy()), pacientes_rel_doct_apar_dicc.copy(), doctors_graph, aparatos_graph)
...
hospital_simulation(pacientes, aparatos, cirugias)
